...
WIDTH = 896
HEIGHT = 768
win = pygame.display.set_mode((WIDTH, HEIGHT), FULLSCREEN, 32)
...
playerDirection = 0
speed = 5
life = [pygame.transform.scale(pygame.image.load('life.png').convert_alpha(), (50, 50)) for i in range(5)]
counter = 0
sprites = []
up_sprites = []
down_sprites = []
...
def draw_score(score):
    ...
    green = (0, 255, 0)
    blue = (0, 0, 128)
    text = font.render('Score: {0}'.format(score), True, green, blue)
    textRect = text.get_rect()
    # set the center of the rectangular object.
    textRect.center = (WIDTH - 100, 20)
